            ...
            For iIndex As Integer = 0 To BillOfMaterials_spr.ActiveSheet.RowCount - 1
                ...
                If Not ChildSheetView1 Is Nothing Then
                    ...
                    For jIndex As Integer = 0 To ChildSheetView1.RowCount - 1
                        ...
                        ChildSheetView1.Cells(jIndex, MAT_COL_QTY).Value = SetSPRText("UnitQty", ChildSheetView1, jIndex)
                        If Not isInitializingComponent Then
            ...
            If Not ChildSheetView1 Is Nothing Then
                ...
                For jIndex As Integer = 0 To ChildSheetView1.RowCount - 1
                    ...
                    For kIndex As Integer = 0 To ChildSheetView1.ColumnCount - 1
                        ...
                        Select Case kIndex
                            Case MAT_COL_MATERIAL_DESC, MAT_COL_STANDARD_HOURS
                            ...
                            Case MAT_COL_MATERIAL_COST
                                If ChildSheetView1.Cells(jIndex, MAT_COL_ORDER_BY).Text = "RL" Or
                                   String.IsNullOrEmpty(ChildSheetView1.Cells(jIndex, MAT_COL_ORDER_BY).Text) Then
